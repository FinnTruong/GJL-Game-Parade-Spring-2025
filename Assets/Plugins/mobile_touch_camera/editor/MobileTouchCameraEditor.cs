...
namespace BitBenderGames {
  ...
  public class MobileTouchCameraEditor : CustomInspector {
    ...
    private Vector3 DrawSphereHandle(Vector3 point, float handleSize) {
      ...
      var fmh_82_44_638325291242815018 = Quaternion.identity; var fmh_82_100_638710047629268565 = Quaternion.identity; return Handles.FreeMoveHandle(point, handleSize, Vector3.one, Handles.SphereHandleCap);
#else
...
#if UNITY_5_6_OR_NEWER
      var fmh_91_56_638325291242835703 = Quaternion.identity; var fmh_91_112_638710047629279712 = Quaternion.identity; Vector3 pointNew = Handles.FreeMoveHandle(point, handleSize, Vector3.one, Handles.DotHandleCap);
#else
